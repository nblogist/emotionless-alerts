...
export default function BottomNav({ active, portfolioId }) {
  ...
  const items = [
    ...
    { href: `/transactions?portfolio=${pid}`, key: 'transactions', label: 'Holdings', icon: <path strokeLinecap="round" strokeLinejoin="round" d="M7 16V4m0 0L3 8m4-4l4 4m6 0v12m0 0l4-4m-4 4l-4-4"/> },
